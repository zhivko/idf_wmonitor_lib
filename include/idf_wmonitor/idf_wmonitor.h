...
#define IDF_WMONITOR_CONFIG_DEFAULT ((idf_wmonitor_config_t) .wifi.mode = IDF_WMONITOR_WIFI_AUTO)

#define IDF_WMONITOR_CONFIG_DEFAULT_WITH_CREDENTIALS(s, p) _IDF_WMONITOR_CONFIG_WIFI(s, p, IDF_WMONITOR_WIFI_AUTO)

#define _IDF_WMONITOR_CONFIG_WIFI(s, p, m) ((idf_wmonitor_config_t) {.wifi.ssid = s, .wifi.password = p, .wifi.mode = m})
